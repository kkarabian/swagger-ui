...
SwaggerResource.prototype.addOperations = function(resource_path, ops, consumes, produces) {
  if (ops) {
    ...
    for (var i = 0; i < ops.length; i++) {
      ...
      op = new SwaggerOperation(o.nickname, resource_path, method, o.parameters, o.summary, o.notes, o.access, type, responseMessages, this, consumes, produces, o.authorizations);
...
var SwaggerOperation = function(nickname, path, method, parameters, summary, notes, access, type, responseMessages, resource, consumes, produces, authorizations) {
  var _this = this;
